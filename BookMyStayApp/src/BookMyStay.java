...
public class BookMyStay {
    ...
    public static void main(String[] args) {
        ...
        while (bookingQueue.hasPendingRequests()) {
            Reservation currentReq = bookingQueue.getNextRequest();
            System.out.println("Processing booking for Guest: " + currentReq.getGuestName() + ", Room Type: " + currentReq.getRoomType());
        }
    }
}